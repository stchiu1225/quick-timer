...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, themes, setTheme, newAudio, soundToggle, show, adjust, toggle, reset, blink, count, run, resize;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
audioRemind = null;
audioEnd = null;
themes = ['track-night', 'carbon-precision', 'pit-redline', 'gauge-cluster'];
setTheme = function(theme){
  var base;
  base = $('body');
  base.removeClass(themes.map(function(it){
    return "theme-" + it;
  }).join(' '));
  base.addClass("theme-" + theme);
  $('.theme-btn').removeClass('active');
  return $(".theme-btn[data-theme='" + theme + "']").addClass('active');
};
...
window.onload = function(){
  $('#timer').text(delay);
  setTheme('track-night');
  $('.theme-btn').on('click', function(){
    return setTheme($(this).data('theme'));
  });
  resize();
