...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, newAudio, soundToggle, show, adjust, toggle, reset, blink, count, run, resize, setTheme, attachThemeButtons;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
setTheme = function(name){
  $('body').removeClass(function(i, cls){
    return (cls.match(/theme-[^\s]+/g) || []).join(' ');
  }).addClass("theme-" + name);
  $('.theme-btn').removeClass('active');
  return $(".theme-btn[data-theme='" + name + "']").addClass('active');
};
attachThemeButtons = function(){
  return $('.theme-btn').on('click', function(){
