...
var start, isBlink, isLight, isRun, isShow, isWarned, handler, latency, stopBy, delay, audioRemind, audioEnd, newAudio, soundToggle, show, adjust, toggle, reset, blink, count, run, resize, setTheme;
start = null;
isBlink = false;
isLight = true;
isRun = false;
...
setTheme = function(theme){
  var classes, target;
  classes = ['theme-gt-dash', 'theme-night-neon', 'theme-carbon-grid', 'theme-vintage-cluster'];
  target = "theme-" + theme;
  $('body').removeClass(classes.join(' ')).addClass(target);
